...
const Testimonials = () => (
  <section className="py-6 alt shadow testimonial" id="testimonials">
    ...
    >
      ...
      <ButtonBack className="testimonial__prev"><FontAwesomeIcon icon="chevron-left" /></ButtonBack>
      <ButtonNext className="testimonial__next"><FontAwesomeIcon icon="chevron-right" /></ButtonNext>
    </CarouselProvider>
  </section>
)
